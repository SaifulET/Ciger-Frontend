...
const CouponDeals: React.FC<CouponDealsProps> = ({ coupons }) => {
  return (
    <div className=' mx-[16px] md:mx-[32px] py-[16px] md:py-[32px] '>
      ...
      <h2 className="text-center font-montserrat text-[28px] font-semibold leading-[48px] pb-[12px]">Smokenza Deals</h2>
      <p className="font-open-sans text-[14px] font-semibold leading-[24px] text-center pb-[16px] md:pb-[32px]">
