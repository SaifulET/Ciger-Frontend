...
const CACHE_KEY = "new-arrivals-products";
const CACHE_TIMESTAMP_KEY = "new-arrivals-products-timestamp";
  ...
  useEffect(() => {
    ...
    const fetchProductsData = async () => {
      ...
      try {
        ...
        const response = await api.get("/product/getAllProduct?new=true");
